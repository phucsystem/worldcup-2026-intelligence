...
- **New** — The Standings page now has a working Knockout tab that unlocks automatically once the knockout bracket is set, showing the full Round of 32 → Final bracket alongside the group tables.
